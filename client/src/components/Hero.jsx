    ...
    >
      <div className="text-center mb-6 ">
        <h1
          ...
          font-semibold mx-auto leanding-[1.2]"
        >
          Create amazing content <br /> with{" "}
          <span className="text-primary">AI tools</span>
        </h1>
        <p className="mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-xs text-gray-600 ">
          Transform your content creation with our suie of premium AI tools.
      ...
      <div className="flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs">
        <button
          onClick={()=>navigate('/ai')}
          className="bg-primary text-white px-10 py-3 rounded-xl  hover:scale-102
        ...
        <button
          className="bg-white px-10 py-3 rounded-xl hover:scale-102 
        active:scale-95  transition cursor-pointer"
        >
          Watch demo
        </button>
