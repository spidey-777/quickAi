...
const WriteArticle = () => {
  const articleLength = [
    ...
    { length: 1200, text: "Midium (800-1200 words)" },
    { length: 1600, text: "large(1200+ words)" },
  ];

  const [selectedLenght, setSelectedLength] = useState(articleLength[0]);
    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        <div className="flex items-center gap-4 mb-6">
          ...
          <h2 className="text-xl font-semibold">Article Configaration</h2>
        </div>
